 ...
 * This file demonstrates how to integrate Yearnvaults with a web frontend
 */

// For React/Vue/Angular applications
export class YearnvaultsClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new YearnvaultsClient(provider, contractAddress);
