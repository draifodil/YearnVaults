...
const contractABI = require("../artifacts/contracts/Yearnvaults.sol/Yearnvaults.json").abi;

program
    .name("yearnvaults-cli")
    .description("CLI tool for Yearnvaults smart contract")
    .version("1.0.0");
